"""Black-Scholes put pricing/delta, used only by the simulated backtest to
reconstruct a THEORETICAL option price from real historical stock prices.
This is a modeling approximation, not an observed historical market price —
see app/backtest/simulated_backtest.py for why, and never treat its output
as a validated historical option quote.
"""
